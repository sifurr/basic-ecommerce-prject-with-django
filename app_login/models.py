...
# for creating custom user model and admin panel
...
# to automatically create one to one objetcs
...
class MyUserManager(BaseUserManager):
    ...
    def _create_user(self, email, password, **extra_fields):
        """ Creates and saves a user with a given email and password with this default function"""
